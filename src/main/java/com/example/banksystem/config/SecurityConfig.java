    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/users/**").hasAuthority(Permission.DEVELOPERS_WRITE.getPermission())
                        .requestMatchers(HttpMethod.PUT, "/users/**").hasAuthority(Permission.DEVELOPERS_WRITE.getPermission())
